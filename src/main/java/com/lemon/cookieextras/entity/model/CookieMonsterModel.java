package com.lemon.cookieextras.entity.model;// Made with Blockbench 4.2.2
...
public class CookieMonsterModel <T extends CookieMonsterEntity> extends EntityModel<T> {
