...
import com.lemon.cookieextras.item.ModArmorMaterial;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<IArmorMaterial, EffectInstance> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<IArmorMaterial, EffectInstance>()
                    .put(ModArmorMaterial.COOKIEGEM, new EffectInstance(Effects.SATURATION, 400))
                    .put(ModArmorMaterial.COOKIEGEM_SUPER, new EffectInstance(Effects.SATURATION, 400, 1))
                    .build();
    ...
    private void addStatusEffectForMaterial(PlayerEntity player, IArmorMaterial mapArmorMaterial, EffectInstance mapStatusEffect) {
