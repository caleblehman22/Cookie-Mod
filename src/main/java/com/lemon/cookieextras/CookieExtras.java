...
@Mod(CookieExtras.MOD_ID)
public class CookieExtras
{
    public static final String MOD_ID = "cookieextras";
    ...
    {
        event.enqueueWork(() -> {
            EntitySpawnPlacementRegistry.register(ModEntityTypes.COOKIE_MONSTER.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND,
